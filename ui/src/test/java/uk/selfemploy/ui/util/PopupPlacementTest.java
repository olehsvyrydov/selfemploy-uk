...
class PopupPlacementTest {
    ...
    class ResolveTopY {
        ...
        void belowWhenRoom() {
            // anchor top=100, height=20 -> bottom=120; screen bottom=800; popup=200 fits (680 space).
            double y = PopupPlacement.resolveTopY(100, 20, 200, 800);
        ...
        void aboveWhenNoRoom() {
            // anchor top=700, height=20 -> bottom=720; screen bottom=800; popup=200 -> only 80 below.
            double y = PopupPlacement.resolveTopY(700, 20, 200, 800);
        ...
        void flippedBottomMeetsAnchorTop() {
            ...
            double y = PopupPlacement.resolveTopY(anchorTop, 20, popupHeight, 800);
