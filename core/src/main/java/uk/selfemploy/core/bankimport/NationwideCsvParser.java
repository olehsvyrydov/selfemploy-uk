...
/**
 * CSV parser for Nationwide bank statements.
 *
 * <p>Nationwide CSV format:
 * Date,Transaction type,Description,Paid out,Paid in,Balance
 */
@ApplicationScoped
public class NationwideCsvParser extends AbstractBankCsvParser {

    private static final String BANK_NAME = "Nationwide";
    private static final String[] EXPECTED_HEADERS = {"Date", "Transaction type", "Description", "Paid out", "Paid in", "Balance"};
